...
This single-user API adds authenticated cloud document storage to PPTist.
...
- `PPTIST_CLOUD_DATABASE`: SQLite database path

Runtime data and password hashes must not be committed to Git.

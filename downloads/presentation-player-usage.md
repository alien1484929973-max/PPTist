...
```text
/downloads/pptist-presentation-player-0.1.1.tgz
...
```bash
npm install https://<PPTist官网域名>/downloads/pptist-presentation-player-0.1.1.tgz
```

若该版本已通过发布工作流推送到 npm，也可使用
`npm install pptist-presentation-player@0.1.1`。注册表是否可用取决于发布状态；离线包和
